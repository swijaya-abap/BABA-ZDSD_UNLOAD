sap.ui.define([
		...
		"com/baba/ZDSD_UNLOAD_V3/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("BNAME"),
									name: oBindingContext.getProperty("BNAME")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all USERSet to be able to check for the total amount
