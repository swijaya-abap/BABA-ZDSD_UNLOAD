sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/baba/ZDSD_UNLOAD/app", ".html");
		...
		return Opa5.extend("com.baba.ZDSD_UNLOAD.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/baba/ZDSD_UNLOAD/localService/mockserver"], function (mockserver) {
